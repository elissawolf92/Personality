...
public class LMAPlayerGUI : MonoBehaviour {
   ...
   // private string[] _animNameStr = { "Knocking", "Pointing", "Lifting", "Picking up pillow", "Punching", "Pushing", "Throwing", "Walking", "Waving" };
    ...
    bool [] _arePositionsSwapped = new bool[EFFORT_COMB_COUNT * ANIM_COUNT];
    ...
    private static string[] _isSubmittedStr = new string[EFFORT_COMB_COUNT * ANIM_COUNT];
    private static bool[] _isSubmitted= new bool[EFFORT_COMB_COUNT * ANIM_COUNT];
    ...
    void Start(){
		...
		// TODO:  Take out all the stuff with answers.  Want this to just play a selected motion
    ...
    void UpdateCameraBoundaries() {
        ...
        /*if (_arePositionsSwapped[_animInd * 48 + _qInd]) {
            ...
            cam2.camera.rect = new Rect(_scrollWidth / Screen.width, 0, ((Screen.width - _scrollWidth) / 2f) 
           						 / Screen.width, 1);
            
            cam3.camera.rect = new Rect((Screen.width - (Screen.width - _scrollWidth) / 2f) 
            					/ Screen.width, 0, ((Screen.width - _scrollWidth) / 2f) / Screen.width, 1);
        }*/
    ...
    void UpdateParameters() {
        ...
        //Update character
        UpdateEmoteParams(_agent, _driveIndRight);
