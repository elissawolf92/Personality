...
{
    /// <summary>
    /// "Invert" Decorators execute their child as normal, but flip the termination
    /// status when that child finishes. "Success" becomes "Failure", and vice versa.
    /// Useful for assertion actions.
    /// </summary>
    public class DecoratorInvert : Decorator
    {
        public DecoratorInvert(Composite child)
            : base(child)
        {
        }
