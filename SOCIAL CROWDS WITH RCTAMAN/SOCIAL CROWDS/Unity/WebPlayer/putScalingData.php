<?php
   ...
   $answerNCAName = "answerNCA";
    ...
    $insert   = "INSERT INTO $table (userId, animName, effortInd,  answerOE, answerNCA) 
                 VALUES ('$userId', '$animName', '$effortInd','$answerOE','$answerNCA')";
    ...
    $answerOEName = $answerOE, $answerNCAName = $answerNCA WHERE 
