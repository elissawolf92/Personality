...
*/
public class AnimationInfoMecanim : MonoBehaviour {
...
//	public int NextGoalKeyInd = 1;
    ...
    public void Reset(string aName) {
		...
		Fps = anim.GetCurrentAnimationClipState (0) [0].clip.frameRate;
        //AnimLength = animation[AnimName].clip.length;		
		AnimLength = anim.GetCurrentAnimationClipState(0)[0].clip.length;
 ...
 /*
	...
	public void InitKeyPoints() {
        ...
        TorsoControllerMecanim torso = GetComponent<TorsoControllerMecanim>();
        ArmInfo[] arms = GetComponent<ArmControllerMecanim>().Arms;
